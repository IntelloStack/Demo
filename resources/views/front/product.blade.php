                ...
                <div id="product-carousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner bg-light">
                        ...
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{asset('front-assets/images/product-2.jpg')}}" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="{{asset('front-assets/images/product-3.jpg')}}" alt="Image">
                        </div>
                        <div class="carousel-item">
